...
//
//  StopWatch.h
//  Launchpad_MIDI_OSC_BA
//
//  Created by Dr X on 24/04/2019.
//
...
private:
    ...
    static unsigned long seconds() { return ofGetElapsedTimeMillis()/1000; };
    static unsigned long millis() { return ofGetElapsedTimeMillis(); };
    static unsigned long micros() { return ofGetElapsedTimeMicros(); };
};
